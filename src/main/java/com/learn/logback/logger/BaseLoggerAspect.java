...
import com.learn.logback.annotations.CardNumberSerializer;
import com.learn.logback.annotations.SensitiveData;
...
public abstract class BaseLoggerAspect {
    ...
    @Pointcut("@within(com.learn.logback.NoLogging)")
